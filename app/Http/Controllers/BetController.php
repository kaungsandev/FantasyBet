...
class BetController extends Controller
{
    ...
    public function trybet(Request $request)
    {
        ...
        Bet::create([ //Store new bet record
    ...
    public function calculateOdds($match_id, $choice)
    {
        ...
        // default value for total_player_count is 1.
        //this is to reduce duplicated code structure.
        $total_player_count = 1;
        if ($total_other_amount === 0) { //If no bet record for opposite team.
            //We use total_player_count from database if there is no bet record for opposite team.
            $total_amount *= 2;
        ...
        } else { //if user bet for away team
