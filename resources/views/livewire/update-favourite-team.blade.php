<div>
   <form class="flex flex-row justify-center mt-8 items-center p-4" wire:submit.prevent="updateFavTeam">
    ...
    <select class="w-1/3 p-2 h-12 rounded-l-md" wire:model='selectedTeam' name="team" id="team">
    ...
    <button class="w-auto p-2 h-12 rounded-r-md bg-theme-color text-white">Update</button>
   </form>
</div>
