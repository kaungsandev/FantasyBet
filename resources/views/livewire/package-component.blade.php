<div class="flex flex-col mt-12">
    ...
    <div class="font-sans min-h-screen flex flex-col justify-start items-start w-full">
        @if ($subscription)
        <div class="w-full flex flex-col md:flex col ">
        ...
        <div class="flex flex-col w-full">
            <div class="text-center font-semibold">
                ...
                <p class="pt-6 text-xl text-gray-400 font-normal w-full">
                    Choose a plan that works best for you 
                </p>
            </div>
            <div class="pt-24 flex flex-col md:flex-row">
                <!-- Basic Card -->
                @foreach ($packages as $package)
                @if($package->auto_sub == false)
                <div class="w-full md:w-1/2 p-8 bg-white mb-2 text-center rounded-3xl shadow-xl">
                    ...
                    <!-- Auto sub Card -->
                    @else   
                    <div class="w-full md:w-1/2 p-8 bg-gray-900 text-center rounded-3xl text-white border-4 shadow-xl border-white transform ">
