<div class="md:w-1/4 lg:w-1/6 border-r-2 h-screen sticky top-0">
    {{-- For Desktop --}}
    <div class="hidden md:flex flex-col justify-around space-y-4 h-full">
        <div class="pl-8">
            <h1 class="uppercase font-extrabold text-xl leading-relax">FantasyBet</h1>
        </div>
        ...
        @else
            <div class=" bg-white rounded flex-col">
                ...
                <x-nav-link :active="request()->routeIs('home')" :href="route('home')">
                    ...
                    <span class="p-2 text-md font-bold pl-4 lg:text-md">Home</span>
                </x-nav-link>
                ...
                <x-nav-link :active="request()->routeIs('bets.history')" :href="route('bets.history')">
                    ...
                    <span class="p-2 text-md font-bold pl-4 lg:text-md">History</span>
                </x-nav-link>
                ...
                <x-nav-link :active="request()->routeIs('fixtures')" :href="route('fixtures')">
                    ...
                    <span class="p-2 text-md font-bold pl-4 lg:text-md">Fixture</span>
                </x-nav-link>
                ...
                <x-nav-link :active="request()->routeIs('players')" :href="route('players')">
                    ...
                    <span class="p-2 text-md font-bold pl-4 lg:text-md">Players Statistics</span>
                </x-nav-link>
            </div>
        @endif
        {{-- Logout --}}
        <div class="hidden md:flex">
            <form action="{{ route('logout') }}" method="POST" class="w-full rounded">
                @csrf
                <button type="submit"
                    class="w-full flex flex-row justify-center focus:text-white border-2 border-l-8 text-red-400  text-center focus:outline-none focus:bg-red-400 border-transparent  inline-flex items-center  text-sm font-medium leading-5">
                    <span class="">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span class="text-md font-bold lg:text-md p-6">Logout</span>
                </button>
            </form>
        </div>
    </div>
